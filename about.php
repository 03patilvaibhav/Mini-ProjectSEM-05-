...
<head>
  ...
  <title>Welcome to inTech-coding forums</title>
  <style>
    section{
      height: 70vh;
    }
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <img src="images/im" alt="" class="bd-placeholder-img" width="100%" height="100%">
...
<h1 class="text-center my-3">Our Mission</h1>
  <div class="row featurette">
    ...
    <div class="col-md-7">
      <h2 class="featurette-heading">First feature. <span class="text-muted">It’ll blow your mind.</span></h2>
      <p class="lead">in2Tech mission is to share and grow the knowledge. A vast amount of the knowledge that would be valuable to many people is currently only available to a few categories. We want to connect the people who have knowledge to the people who need it.</p>
    </div>
    <div class="col-md-5">
  ...
  <div class="row featurette">
    <div class="col-md-7 order-md-2">
      ...
      <p class="lead">It is an initiative to help the upcoming students with the discussion forum. in2Tech focuses on providing the most efficient way to solve your quries or solution wants to be simple way.We will help students build up concepts and easy to solve their quries.</p>
    </div>
